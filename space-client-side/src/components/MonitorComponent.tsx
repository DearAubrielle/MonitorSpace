  ...
  return (
    <div className={styles.monitorContainer}>
      <div className={styles.cameraGrid}>
        {cameras.map((camera) => (
          <div key={camera.id} className={styles.cameraCard} onClick={() => handleCameraClick(camera)}>
            <div className={styles.cameraHeader}>
              ...
              <div className={styles.cameraStatus}>
                ...
                <span className={styles.statusText}>{imageErrors[camera.id] ? 'Offline' : 'Live'}</span>
              </div>
            </div>
            ...
            <div className={styles.expandedHeader}>
              <div className={styles.expandedTitleSection}>
                ...
                <div className={styles.expandedStatus}>
                  <div
                    className={`${styles.statusDot} ${imageErrors[expandedCamera.id] ? styles.offline : styles.online}`}
                  ></div>
                  <span className={styles.statusText}>{imageErrors[expandedCamera.id] ? 'Offline' : 'Live'}</span>
                </div>
              </div>
              <button className={styles.closeButton} onClick={handleCloseExpanded} aria-label="Close expanded view">
                ×
              </button>
            </div>
              ...
              <div className={styles.videoOverlay}>
                ...
                <div className={styles.overlayBottom}>
                  <div className={styles.overlayActions}>
                    ...
                    <button className={styles.overlayButton} onClick={handleRefreshFeed} title="Refresh Feed">
                      🔄
                    </button>
                  </div>
                </div>

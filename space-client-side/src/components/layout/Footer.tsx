            ...
            <div className={styles.container}>
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.brandSection}>
                        <h3 className={styles.brandName}>MonitorSpace</h3>
                        <p className={styles.brandDescription}>
                            Advanced monitoring and surveillance solutions for modern spaces
                        </p>
                    </div>
                    ...
                    <div className={styles.linksGrid}>
                        <div className={styles.linkColumn}>
                            ...
                            <ul className={styles.linkList}>
                                ...
                                <li><a href="#devices" className={styles.link}>Devices</a></li>
                                <li><a href="#floorplans" className={styles.link}>Floor Plans</a></li>
                                <li><a href="#monitoring" className={styles.link}>Live Monitoring</a></li>
                            </ul>
                        </div>
                        ...
                        <div className={styles.linkColumn}>
                            ...
                            <ul className={styles.linkList}>
                                <li><a href="#realtime" className={styles.link}>Real-time Data</a></li>
                                <li><a href="#alerts" className={styles.link}>Smart Alerts</a></li>
                                <li><a href="#analytics" className={styles.link}>Analytics</a></li>
                ...
                <div className={styles.bottom}>
                    <div className={styles.bottomLeft}>
                        <p className={styles.copyright}>
                            © {currentYear} MonitorSpace. All rights reserved.
                        </p>
                        <div className={styles.badges}>
                            <span className={styles.badge}>Enterprise Grade</span>
